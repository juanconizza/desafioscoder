...
class ProductRouter extends CustomRouter {
  init() {
    ...
    this.create("/",["USER"], validateProductsProps, async (req, res, next) => {
      try {
        const data = req.body;
    ...
    this.update("/:pid",["USER"], validateProductsProps, async (req, res, next) => {
      try {
        const productId = req.params.pid;
    ...
    this.destroy("/:pid",["USER"], async (req, res, next) => {
      try {
        const productId = req.params.pid;
